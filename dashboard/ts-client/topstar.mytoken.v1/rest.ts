...
import { QueryParamsResponse } from "./types/topstar/mytoken/v1/query";

import { QueryParamsRequest } from "./types/topstar/mytoken/v1/query";
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @tags Query
   * @name queryParams
   * @request GET:/topstar/mytoken/v1/params
   */
  queryParams = (
    ...
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryParamsResponse>>>({
      path: `/topstar/mytoken/v1/params`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
